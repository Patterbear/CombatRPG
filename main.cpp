...
// Pause function
// Pauses gameplay until key has been pressed
void pause() {
...
class Shop {
	...
	// Vector of shop items
	vector<unique_ptr<Object>> shopItems_;

public:

	// Default constructor
	// Creates shop and its items
	Shop() {
	...
	// Visit shop method
	// Gives player an item from the shop
...
// Ask and use item function
// Asks player if they would like to use an item
// If specified item exists in inventory, it is used
